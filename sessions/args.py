# argparse là thư viện chuẩn của Python dùng để: Nhận tham số từ command line khi chạy file .py
import argparse

# Tạo hàm để: Thu thập tất cả training parameters; Trả về chúng dưới dạng một object
def get_args():
